...
public class LogInFragment extends AuthFragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(view!=null){
            ...
            pass = view.findViewById(R.id.password_input_edit);
...
//                    Intent in = new Intent(getActivity(),ChatbotActivity.class);
                    Intent in = new Intent(getActivity(),NavActivity.class);
                    startActivity(in);

                    String em = email.getText().toString();
                    String ps = pass.getText().toString();

//                    Log.e("Email :"+em+":::","pass:"+ps);
                }
            });
        }
    }
